...
# Ceiling on dataset insert threads. One knob sizes both the compressor pool and
# the upload's byte budget (two batches per worker), so an unbounded value
# authorises an unbounded resident bound.
